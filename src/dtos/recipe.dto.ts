...
export const UpdateRecipeDto = RecipeScheme.pick({
    ...
    ingredients: RecipeScheme.shape.ingredients.optional(),
    steps: RecipeScheme.shape.steps.optional(),
    initialPreparation: RecipeScheme.shape.initialPreparation.optional(),
    ...
    cuisine: RecipeScheme.shape.cuisine.optional(),
